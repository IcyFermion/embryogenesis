...
$T=247$; embryo 3, $T=225$). The respective tracks contain 299, 301, and 298
usable terminal parent--child edges. All comparisons use the strict
intersection of 275 edges (92.0\%, 91.4\%, and 92.3\% of the available edges,
...
black cross marks the shared natural assignment, blue diamonds with
replicate-colored outlines mark each front's maximum-edge-retention assignment,
gold points show 1,000
...
replicate-sensitive. The objectives remain separate and are not combined into
an efficiency score.}
